...
console.log(
  `\nSummary: ${allImages.length} source images → ${slotOutputs} site outputs + ${petOutputs} pets + ${shopOutputs} shop + ${yappyGalleryOutputs} yappy gallery + ${libraryOutputs} library`,
);
