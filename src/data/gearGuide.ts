  ...
  dept(
    ...
    [
      ...
      },
      {
        ...
        imageKey: "stainless-bowls",
        imageAlt: "Set of four stainless steel dog bowls for daycare feeding and water stations",
        link: "https://amzn.to/4y0AgYL",
        priority: 2,
      },
      {
        id: "washable-crate-pad",
        name: "Ultra Soft Washable Crate Bed Pad (24\", Cream)",
        department: "The Daycare Setup",
        badge: "On Our Shopping List",
        whyItMadeTheList:
          "This is the actual crate pad on our list — an ultra-soft, washable, anti-slip kennel mat sized for small dogs (cream, 24 inch). It works as a cozy sleeping mat inside a crate, not a loose blanket throw.",
        bestFor: [
          "Small dogs in 24-inch crates",
          "Kennel and crate sleeping mats",
          "Washable rest pads between stays",
          "Anti-slip crate floors",
        ],
        notIdealFor: [
          "Medium or large dogs — size up for bigger crates",
          "Dogs who chew soft bedding",
          "Dogs who need orthopedic foam support",
        ],
