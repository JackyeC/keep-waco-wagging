...
const bookingPaths: BookingPath[] = [
  ...
  },
  {
    ...
    description:
      "Overnight care in a calm Waco home — walks, enrichment, rest, and daily updates. Request dates on Rover.",
    href: ctas.bookPetCare.href,
    external: true,
    label: "Request boarding on Rover",
    learnHref: "/dog-boarding-waco-tx",
    learnLabel: "Dog boarding details",
  ...
  },
  {
    ...
    description:
      "Play, enrichment, and real rest during the day — not a warehouse floor. Request a daycare day on Rover.",
    href: ctas.bookPetCare.href,
    external: true,
    label: "Request daycare on Rover",
    learnHref: "/dog-daycare-waco-tx",
    learnLabel: "Daycare details",
    photo: designPhotos.svcBoard,
  },
  {
  ...
  },
  {
    ...
    description:
      "Themed summer daycare weeks in Waco. The 2026 season has wrapped — year-round daycare is open now.",
    href: "/dog-daycare-waco-tx",
    external: false,
    label: "See year-round daycare",
