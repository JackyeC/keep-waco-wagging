...
import { brandLanguage, cityConfig, ctas, siteConfig } from "@/lib/site";

const pageTitle = "The Keep Waco Wagging Gear Guide | Dog Products We Use in Waco, TX";
...
export const metadata: Metadata = {
  ...servicePageMetadata("/gear-guide", pageTitle, pageDescription),
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: `${cityConfig.url}/gear-guide`,
    siteName: cityConfig.name,
    type: "website",
    images: [{ url: sitePhotos.training.src, alt: sitePhotos.training.alt }],
  },
};
...
export default function GearGuidePage() {
  ...
  return (
    <>
          ...
          <div className="absolute inset-0 flex flex-col">
            <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-between px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
              ...
              <div className="pb-4 sm:pb-8">
                ...
                <h1 className="mt-3 max-w-4xl font-display text-[clamp(2.25rem,6.5vw,4.5rem)] leading-[1.02] tracking-[-0.03em] text-cream">
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                  <Button
                    ...
                    variant="secondary"
                    size="lg"
                    className="border-cream/30 bg-cream/10 text-cream hover:bg-cream/20"
                  >
                    Read the Guide
                  </Button>
      ...
      <section className="border-b border-clay bg-cream py-6">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-xs leading-relaxed text-bark-faint">
            Looking for {brandLanguage.primaryName} shirts?{" "}
            <Link href={ctas.visitShop.href} className="font-medium text-sage-700 hover:underline">
              Visit the Shop
            </Link>{" "}
            for merch — this guide is Amazon affiliate gear we use and recommend.
          </p>
        </div>
      </section>
      ...
      <section
        id="guide-contents"
        className="scroll-mt-20 border-b border-clay bg-cream py-14 md:py-16"
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      ...
      <section className="border-t border-clay bg-cream py-10">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row sm:flex-wrap">
            ...
            <Button href={ctas.visitShop.href} variant="ghost" size="md">
              {brandLanguage.primaryName} Merch
            </Button>
          </div>
        </div>
      </section>
